...
if (yourname == null || yourname == "" || yourname.length < 2) {
    ...
    if (age == null || age == "" || isNaN(age) == true) {
        ...
        alert("Sembra che il valore inserito non sia corretto. Esprimi la tua età in anni, inserendo solo numeri, per esempio: 25. Ricarica la pagina e riprova, il tuo viaggio ti attende!");
        ...
        if (kilometres == null || kilometres == "" || kilometres < 1 || isNaN(kilometres) == true) {
            ...
            alert("Sembra che il valore inserito non sia corretto. Esprimi la distanza in chilometri inserendo solo numeri, per esempio: 76. Ricarica la pagina e riprova, il tuo viaggio ti attende!");
